...
async function main() {
  ...
  const workflows = [
    ...
    },
    {
      ...
      config: {
        ...
        actions: [
          {
            type: "auto_reply_ai",
            payload: { instructions: "Tu es le premier point de contact du support client. Réponds courtoisement. Pour toute question sur les délais, réponds : 'Nos livraisons s'effectuent sous 24 à 48h'. Si la question est trop technique, dis que l'équipe humaine va reprendre le relais." }
          }
        ]
      }
    },
    ...
    {
      title: "Alerte de Vente VIP (Télégram & WhatsApp)",
