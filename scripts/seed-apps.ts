...
async function main() {
  ...
  const apps = [
    ...
    { id: 'telegram-alerts', name: 'Alertes & Bot Telegram', description: 'Recevez des notifications en direct sur Telegram pour vos ventes et alertes stock.', category: 'Marketing', features: ['Alertes Ventes', 'Infos Stock', 'Temps Réel'], is_premium: false, active: true, icon_url: 'telegram-alerts' },
    ...
    { id: 'ai-generator', name: 'Assistant Coach IA', description: 'L\'Intelligence Artificielle qui rédige vos textes de vente et structure vos offres.', category: 'Création', features: ['Génération de Copy', 'Création de Mails', 'Coach Business'], is_premium: true, active: true, icon_url: 'ai-generator' },
    ...
    { id: 'cinetpay', name: 'CinetPay', description: 'Acceptez MTN, Moov, Orange, Visa et Mastercard dans toute l\'Afrique.', category: 'Paiements', features: ['Multi-pays', 'Cards', 'Mobile Money'], is_premium: false, active: true, icon_url: 'cinetpay' },
    { id: 'paytech', name: 'PayTech', description: 'Alternative solide pour les paiements locaux avec API.', category: 'Paiements', features: ['API Robuste', 'Sécurisé', 'Devises locales'], is_premium: false, active: true, icon_url: 'paytech' },
    { id: 'intouch', name: 'InTouch', description: 'Solution complète pour les gros volumes de transactions.', category: 'Paiements', features: ['Corporate', 'Paiement de masse', 'Guichet'], is_premium: true, active: true, icon_url: 'intouch' },
