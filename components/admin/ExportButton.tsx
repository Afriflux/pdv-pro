...
export function ExportButton() {
  ...
  return (
    <button 
      ...
      disabled={loading}
      className="flex items-center gap-2 px-5 py-2.5 bg-[#1A1A1A] hover:bg-[#2A2A2A] text-white text-xs uppercase tracking-widest font-black rounded-xl shadow-xl hover:shadow-2xl transition-all duration-300 border border-gray-800 disabled:opacity-50 disabled:cursor-not-allowed group"
    >
