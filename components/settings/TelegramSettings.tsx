                  ...
                  <div className="space-y-6 pt-2 relative z-10">
                    <div className="bg-white/5 rounded-2xl p-5 border border-white/10">
                      <p className="text-[13px] text-gray-300 font-medium leading-loose">
                        <span className="inline-flex w-5 h-5 items-center justify-center bg-blue-500 text-white rounded-full text-[10px] font-black mr-2">1</span> Ouvrez <b className="text-white">@PDVProBot</b> sur Telegram<br/>
