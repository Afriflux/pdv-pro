...
// Types
// ----------------------------------------------------------------
interface PortalMobileBottomNavProps {
  userName: string
  storeName: string
...
const PROFILE_LINKS: ProfileLink[] = [
  { icon: Wallet, label: 'Mon Portefeuille', href: '/portal/wallet', color: 'text-emerald-500' },
  { icon: BarChart3, label: 'Analytics', href: '/portal/analytics', color: 'text-blue-500' },
  { icon: ShoppingBag, label: 'Programmes / Marché', href: '/portal/marketplace', color: 'text-purple-500' },
  { icon: Image, label: 'Ressources Promo', href: '/portal/resources', color: 'text-pink-500' },
  { icon: CalendarDays, label: 'Mes Réservations', href: '/portal/agenda', color: 'text-orange-500' },
  { icon: Sparkles, label: 'Mes Tâches', href: '/portal/tasks', color: 'text-amber-500' },
  { icon: Workflow, label: 'Automatisations', href: '/portal/workflows', color: 'text-indigo-500' },
  { icon: GraduationCap, label: 'Académie', href: '/portal/academy', color: 'text-teal-500' },
  { icon: Settings, label: 'Paramètres', href: '/portal/settings', color: 'text-gray-500' },
]

// ----------------------------------------------------------------
// Component
// ----------------------------------------------------------------
export function PortalMobileBottomNav({ userName, storeName, avatarUrl }: PortalMobileBottomNavProps) {
  ...
  const tabs = [
    { icon: LayoutDashboard, label: 'Accueil', href: '/portal' },
    { icon: LinkIcon, label: 'Liens', href: '/portal/links' },
    { icon: ListOrdered, label: 'Ventes', href: '/portal/sales' },
  ...
  return (
    <>
      {/* ── Bottom Tab Bar ── */}
      <nav className="fixed bottom-0 left-0 right-0 z-50 lg:hidden pb-safe" role="navigation" aria-label="Navigation principale affilié">
