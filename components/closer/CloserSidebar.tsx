      ...
      <div className="bg-[#1A1A1A] border border-white/10 rounded-[2rem] p-8 max-w-sm w-full shadow-2xl relative animate-in fade-in zoom-in duration-300">
        ...
        <div className="flex items-center gap-3">
          ...
          <a
            ...
            className="flex-1 py-3 bg-emerald-600 hover:bg-emerald-500 text-white text-center font-bold rounded-xl transition-all text-sm shadow-lg shadow-emerald-500/20 block"
          >
            Confirmer
          </a>
        </div>
          ...
          <div className={`flex items-center ${collapsed ? '' : 'gap-3 mb-3'}`}>
            ...
            {!collapsed && (
              <div className="flex-1 min-w-0">
                <p className="text-[14px] font-black text-white truncate leading-tight tracking-tight">{storeName}</p>
                <p className="text-[11px] text-white/50 truncate uppercase tracking-wider font-semibold mt-0.5">{userName}</p>
              </div>
            )}
          </div>
