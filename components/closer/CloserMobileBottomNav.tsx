...
// Types
// ----------------------------------------------------------------
interface CloserMobileBottomNavProps {
  userName: string
  storeName: string
...
const PROFILE_LINKS: ProfileLink[] = [
  { icon: Wallet, label: 'Mon Portefeuille', href: '/closer/wallet', color: 'text-emerald-500' },
  { icon: Target, label: 'Mes Cibles', href: '/closer/targets', color: 'text-red-500' },
  { icon: Calendar, label: 'Mon Agenda', href: '/closer/agenda', color: 'text-blue-500' },
  { icon: Users, label: 'Performance', href: '/closer/analytics', color: 'text-purple-500' },
  { icon: GraduationCap, label: 'Académie', href: '/closer/academy', color: 'text-amber-500' },
  { icon: Package, label: 'Ressources', href: '/closer/resources', color: 'text-pink-500' },
  { icon: Settings, label: 'Paramètres', href: '/closer/settings', color: 'text-gray-500' },
...
// Component
// ----------------------------------------------------------------
export function CloserMobileBottomNav({ userName, storeName, avatarUrl }: CloserMobileBottomNavProps) {
  ...
  const tabs = [
    { icon: LayoutDashboard, label: 'Accueil', href: '/closer' },
    { icon: Inbox, label: 'Terminal', href: '/closer/terminal' },
    { icon: PhoneCall, label: 'Appels', href: '/closer/calls' },
    { icon: Wallet, label: 'Wallet', href: '/closer/wallet' },
  ]
  ...
  return (
    <>
      {/* ── Bottom Tab Bar ── */}
      <nav className="fixed bottom-0 left-0 right-0 z-50 lg:hidden pb-safe" role="navigation" aria-label="Navigation principale closer">
