...
export default function AmbassadorDashboard({ stats }: { stats: AmbassadorStats }) {
  const { ambassador, referrals, recentTransactions, pendingCommissions } = stats
  // Use window.location.origin or fallback
      ...
      <div className="max-w-5xl mx-auto px-4 py-8 space-y-8">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="bg-white border border-gray-100 rounded-2xl p-5 shadow-sm">
            ...
            <p className="text-xs text-gray-400 mt-0.5">CA ≥ {(ambassador.minCaRequirement / 1000).toLocaleString('fr-FR')} K FCFA</p>
          </div>
        </div>
