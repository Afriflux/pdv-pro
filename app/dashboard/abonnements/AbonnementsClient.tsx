  ...
  return (
    <div className="min-h-screen bg-[#F8F9FA] pb-24 font-body relative overflow-hidden">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10">
            <div className="space-y-4">
              ...
              <p className="text-slate font-medium text-base max-w-2xl leading-relaxed">
                Zéro abonnement fixe. <strong className="text-ink">{storeName}</strong>, avec PDV Pro, la commission s'adapte à votre succès. De <strong className="text-[#0F7A60]">{tiers[0].rate}% à {tiers[tiers.length - 1].rate}%</strong> au fur et à mesure que vous grandissez.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4 overflow-x-auto hide-scrollbar border-b border-gray-200/60 pb-px">
            {[
              ...
              >
                ...
                {activeTab === tab.id && (
                  <div className="absolute bottom-0 left-0 w-full h-0.5 bg-[#0F7A60] rounded-t-full shadow-[0_-2px_8px_rgba(15,122,96,0.5)]"></div>
                )}
              </button>
            ))}
          </div>
      ...
      <div className="w-full px-6 py-10 relative z-10">
          ...
          <div className="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="bg-white/70 backdrop-blur-xl rounded-[2.5rem] p-2 border border-white shadow-[0_8px_30px_rgb(0,0,0,0.04)] ring-1 ring-gray-900/5 overflow-hidden">
              <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-gray-200/50">
                {/* CA Box */}
                <div className="p-8 hover:bg-white transition-colors duration-500 rounded-[2.2rem]">
                ...
                <div className="p-8 hover:bg-white transition-colors duration-500 rounded-[2.2rem]">
                  <div className="flex items-center gap-3 mb-4">
                    <div className="w-10 h-10 rounded-full bg-amber-50 text-amber-500 flex items-center justify-center shadow-sm">
                      <Wallet size={20} />
                    </div>
                ...
                <div className="p-8 bg-gradient-to-br from-[#0F7A60]/5 to-transparent hover:from-[#0F7A60]/10 transition-colors duration-500 rounded-[2.2rem] relative overflow-hidden group">
                  ...
                  <div className="flex items-center gap-3 mb-4 relative z-10">
                    <div className="w-10 h-10 rounded-full bg-[#0F7A60] text-white flex items-center justify-center shadow-md shadow-[#0F7A60]/20">
                      <Trophy size={20} />
                    </div>
              ...
              <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 relative z-10 gap-4">
                <div>
                  <div className="inline-flex items-center gap-2 bg-emerald-500/10 text-emerald-400 font-black text-[10px] uppercase tracking-widest px-3 py-1.5 rounded-full mb-3 border border-emerald-500/20">
                    <Sparkles size={14} /> Votre évolution sur PDV Pro
                  </div>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex-1 p-6 relative flex flex-col justify-center">
                          {isCurrent && (
                            <div className="animate-in fade-in zoom-in-95 duration-700 h-full flex flex-col justify-center">
                          ...
                          {isPast && (
                            <div className="h-full flex flex-col items-center justify-center text-center">
                              <div className="w-12 h-12 rounded-full bg-white/5 flex items-center justify-center text-emerald-400/80 mb-3 border border-white/10 shadow-sm backdrop-blur-sm">
                                <ShieldCheck size={20} />
                              </div>
                          ...
                          {isFuture && (
                            <div className="h-full flex flex-col items-center justify-center text-center">
                              <div className="w-12 h-12 rounded-full bg-white/5 flex items-center justify-center text-white/20 mb-3 border border-white/5 border-dashed backdrop-blur-sm">
                                <Lock size={20} />
                              </div>
        ...
        {/* ── TAB: SIMULATEUR ─────────────────────────────────────────────────── */}
        {activeTab === 'simulator' && (
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 w-full py-8">
                 ...
                 {monthStats.map((stat, i) => (
                   <div key={i} className="p-8 flex flex-col lg:flex-row lg:items-center justify-between gap-8 hover:bg-gray-50/50 transition-colors group">
                     ...
                     <div className="flex-1 flex items-center justify-between gap-6 flex-wrap bg-white rounded-2xl p-4 border border-gray-100 shadow-sm group-hover:border-[#0F7A60]/20 transition-colors">
                        ...
                        <ChevronRight className="text-gray-200 hidden sm:block" size={16} />
                        <div>
                          <p className="text-[10px] uppercase tracking-widest text-amber-600/70 mb-1 font-bold">Frais PDV Pro</p>
