...
import { Wallet, Smartphone, Building2, Landmark, CheckCircle2, Loader2, ArrowRightLeft, ShieldCheck, CreditCard, UploadCloud, AlertTriangle, FileCheck } from 'lucide-react'
...
export function FinanceTab({ store }: { store: any }) {
  ...
  // KYC State
  const [kycStatus, setKycStatus] = useState<string>(store?.kyc_status ?? 'unverified')
  const [kycDocType, setKycDocType] = useState<string>(store?.kyc_document_type ?? 'cni')
        ...
        <div className="px-6 sm:px-12 pb-12 relative z-10 w-full">
          ...
          <div className="pb-10 space-y-2">
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <span className="text-[14px] text-gray-500 font-medium">Configurez et sécurisez votre compte.</span>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-10">
            ...
            {/* === SÉCURITÉ / KYC === */}
            <div className="bg-white/60 border border-gray-200/80 rounded-[2rem] p-6 sm:p-8 backdrop-blur-sm shadow-sm relative overflow-hidden">
               <div className="flex flex-col lg:flex-row gap-8 items-start">
                 <div className="flex-1">
                   ...
                   <p className="text-sm text-gray-500 leading-relaxed max-w-xl">
                     Conformément à la réglementation financière en vigueur, vous devez vérifier votre identité avant de pouvoir initier des retraits depuis votre portefeuille.
                   </p>
                   ...
                   {kycStatus === 'verified' ? (
                     ...
                     <form onSubmit={handleKycSubmit} className="mt-6 space-y-5 max-w-lg">
                       ...
                       <button 
                         ...
                         className="px-6 py-2.5 bg-gray-900 hover:bg-black text-white rounded-xl font-bold text-sm shadow-md transition-all flex items-center gap-2 disabled:opacity-50 w-full justify-center"
                       >
            ...
            <div className="h-px bg-gray-200/60 w-full my-[-10px]"></div>

            {/* === SÉLECTION DU FOURNISSEUR (3 Cartes Massives) === */}
            <div className={kycStatus !== 'verified' ? 'opacity-50 pointer-events-none grayscale-[30%] transition-all' : 'transition-all'}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-4xl">
                ...
                <div className="group relative">
                  ...
                  <div className="relative bg-white/60 backdrop-blur-md rounded-[1.2rem] border border-gray-200/80 p-5 focus-within:ring-2 focus-within:ring-emerald-500/20 focus-within:border-emerald-500 transition-all flex flex-col gap-2">
                    ...
                    <input 
                      title={withdrawalMethod === 'bank' ? "IBAN / RIB Complet" : "Numéro de téléphone"}
                      type="text"
                ...
                <div className="group relative">
                  ...
                  <div className="relative bg-white/60 backdrop-blur-md rounded-[1.2rem] border border-gray-200/80 p-5 focus-within:ring-2 focus-within:ring-emerald-500/20 focus-within:border-emerald-500 transition-all flex flex-col gap-2">
                    ...
                    <input 
                      title="Nom complet du titulaire"
                      type="text"
          ...
          <div className="mt-8 flex justify-end border-t border-gray-200/50 pt-8">
            ...
            >
              ...
              {kycStatus !== 'verified' ? 'Compte Non Vérifié' : 'Sauvegarder les coordonnées'}
            </button>
          </div>
