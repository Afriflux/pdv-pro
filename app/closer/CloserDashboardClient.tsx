...
const CloserChart = dynamic(() => import('./CloserChart'), {
  ssr: false,
  loading: () => <div className="w-full h-full min-h-[300px] bg-slate-50 animate-pulse rounded-2xl" />
})
        ...
        <div className="flex flex-col lg:flex-row gap-6 w-full">
          ...
          >
            ...
            <div className="flex-1 w-full h-full min-h-[300px] relative z-10">
              <CloserChart data={mockChartData} />
            </div>
          </motion.div>
